function xgf=makegrid_tilteddipole_varx2_3D_eq(dtheta,dphi,~,lqp,lphip,altmin,glat,glon,gridflag)
...
coeffs=2*[4.65e-4, 0.0024, -5.7195e-04];   %3D Moore run for Snively's paper, low res
